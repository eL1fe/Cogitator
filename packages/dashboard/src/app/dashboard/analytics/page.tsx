    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between animate-fade-in">
        <div>
          ...
          <p className="text-text-secondary mt-1">Usage statistics and cost breakdown</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="animate-fade-in" style={{ animationDelay: '200ms' }}>
          <h3 className="text-lg font-medium text-text-primary mb-4">Usage Over Time</h3>
          {loading ? (
        ...
        <Card className="animate-fade-in" style={{ animationDelay: '250ms' }}>
          <h3 className="text-lg font-medium text-text-primary mb-4">Cost by Model</h3>
          {loading ? (
            <Skeleton className="h-64 w-full" />
          ) : modelData.length === 0 ? (
      ...
      <Card className="animate-fade-in" style={{ animationDelay: '300ms' }}>
        <h3 className="text-lg font-medium text-text-primary mb-4">Top Agents</h3>
        {loading ? (
          ...
          <div className="py-8 text-center text-text-muted">No agent data available</div>
        ) : (
              ...
              <tbody className="divide-y divide-border-primary">
                {data?.topAgents.map((agent) => (
                  <tr key={agent.id} className="hover:bg-bg-tertiary">
                    ...
                    <td className="py-3 text-text-secondary">{agent.model}</td>
                    ...
                    <td className="py-3 text-right text-text-primary">${agent.cost.toFixed(4)}</td>
