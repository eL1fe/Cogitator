        ...
        {selectedThread ? (
          <>
            ...
            <div className="p-4 border-b border-border-subtle bg-bg-secondary flex items-center justify-between">
              ...
              <Button variant="danger" size="sm" onClick={() => deleteThread(selectedThread.id)}>
            ...
            <div className="flex-1 overflow-auto p-6">
              <div className="max-w-3xl mx-auto space-y-4">
                <Card>
                  <h4 className="font-medium text-text-primary mb-4">Thread Info</h4>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-text-muted">ID</span>
                      <span className="text-text-primary font-mono">{selectedThread.id}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-text-primary">{selectedThread.messageCount}</span>
                    </div>
                  </div>
                </Card>
                ...
                {Object.keys(selectedThread.metadata).length > 0 && (
                  <Card>
                    <h4 className="font-medium text-text-primary mb-4">Metadata</h4>
                ...
                <Card className="bg-bg-tertiary border-dashed">
                  <div className="text-center py-8 text-text-muted">
                    ...
                    <p className="text-sm">Message history is stored in the memory adapter.</p>
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-text-primary mb-2">Select a Thread</h3>
