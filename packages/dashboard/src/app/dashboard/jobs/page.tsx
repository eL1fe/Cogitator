    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between animate-fade-in">
        <div>
          ...
          <p className="text-text-secondary mt-1">Monitor and manage background tasks</p>
        </div>
        <button
          onClick={() => fetchData()}
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <Icon
                    className={`w-5 h-5 ${config?.color || 'text-text-tertiary'} ${config?.animate ? 'animate-spin' : ''}`}
                  />
                </div>
      ...
      {/* Jobs List */}
      <div
        className="bg-bg-secondary border border-border-primary rounded-xl overflow-hidden animate-fade-in"
      ...
      >
        {loading ? (
          ...
          <div className="p-8 text-center text-text-secondary">No jobs found</div>
        ) : (
