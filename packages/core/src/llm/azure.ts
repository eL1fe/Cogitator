 ...
 *
 * Uses the official OpenAI SDK with Azure configuration.
 * Supports all OpenAI features: chat, streaming, tools, vision.
 */
...
export class AzureOpenAIBackend extends BaseLLMBackend {
